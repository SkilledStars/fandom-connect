...
const (
	...
	defaultListen              = ":8080"
	defaultGoogleAdsAPIVersion = "v23"
)
...
func LoadRuntimeConfig() (RuntimeConfig, error) {
	...
	if baseURL.Scheme == "https" {
		...
		if (baseURL.Port() != "" && baseURL.Port() != "443") ||
			...
			return cfg, errors.New("GATEWAY_BASE_URL must use a public DNS hostname on the standard HTTPS port")
		}
	...
	if !googleAdsAPIVersionPattern.MatchString(cfg.GoogleAdsAPIVersion) {
		return cfg, errors.New("GATEWAY_GOOGLE_ADS_API_VERSION must look like v23")
	}
	return cfg, nil
}
